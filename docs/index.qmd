...
![Horse populations for all provinces in Canada from 1906 - 1972.](horse_pops_plot.png){#fig-horse_pops_plot width=80%}
...
horses_sd_table = pd.read_csv("horses_sd.csv")
...
![Horse populations for the province with the largest standard deviation](horse_pops_plot_largest_sd.png){#fig-horse_pops_plot_largest_sd width=60%}
